...
For this demo we can mock one using Mailhog[https://github.com/mailhog/MailHog]. To access it just hit the URL:
...
To demonstrate that feature you need an application like the one here[https://github.com/GuilhermeCamposo/demo_camel_k/tree/main].
