...
In the `dev_portal` folder you will find an automation to update the Developer Portal in a specific environment. Run the playbook the same way you run the installation playbook
